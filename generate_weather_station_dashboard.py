...
PANELS = [
  ...
  |> yield(name: "mean")""",
        ...
        "targets": [
            {
                "datasource": {"type": "influxdb", "uid": "1wu58U1Vz"},
                "hide": False,
  ...
  |> yield(name: "mean")""",
        ...
        "fieldConfig": {
            "defaults": {
                ...
                "color": {"mode": "palette-classic", "fixedColor": "blue"},
                "mappings": [],
                "thresholds": {
                    "mode": "absolute",
                    "steps": [
...
for panel in PANELS:
    ...
    if panel["type"] == "timeseries":
        panel_data["yaxes"] = [
            {"label": panel["y_axis_label"], "format": "short", "show": True},
