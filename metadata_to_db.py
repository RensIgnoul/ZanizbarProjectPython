...
if __name__=='__main__':
    ...
    mqtt_client.username_pw_set("flwsb",os.getenv("MOSQUITTO_PASSWD")
    mqtt_client.connect("mqtt.iot-ap.be",1881)

    t = os.popen('vcgencmd measure_temp').readline()
    print(t)
    calculated_current=current/1000
    payload = {
    ...
    mqtt_client("gateway_debugging",json_payload)
